...
## Задача: Поддержка Yoast SEO в генерации коллекции
- **Статус**: Завершена
- **Описание**: Добавить проверку активности плагина Yoast SEO и автоматическое включение yoast_head_json в параметр _fields для pages и posts.
- **Шаги выполнения**:
  - [x] Добавить метод is_yoast_active() для проверки активности плагина Yoast SEO
  - [x] Добавить методы get_fields_param() и get_detailed_fields_param() для генерации параметра _fields
  - [x] Обновить все места использования _fields в get_basic_routes() для pages и posts
  - [x] Обновить get_standard_custom_post_type_routes() для поддержки Yoast в CPT
  - [x] Обновить get_individual_page_routes() для поддержки Yoast
  - [x] Обновить документацию в Project.md с информацией о поддержке Yoast
  - [x] Обновить tasktracker.md
- **Зависимости**: Нет

## Задача: Обновление версии плагина до 1.0.2
- **Статус**: Завершена
- **Описание**: Обновить версию плагина с 1.0.1 на 1.0.2 после добавления поддержки Yoast SEO.
- **Шаги выполнения**:
  - [x] Обновить версию в postman-collection.php (заголовок и константа)
  - [x] Обновить Stable tag в readme.txt
  - [x] Добавить запись в Changelog с описанием изменений Yoast SEO
  - [x] Обновить Upgrade Notice
  - [x] Обновить версию в файле языков
  - [x] Обновить документацию в tasktracker.md
- **Зависимости**: Поддержка Yoast SEO

## Задача: Добавление заголовка Accept-Language в запросы
- **Статус**: Завершена
- **Описание**: Добавить заголовок Accept-Language во все GET-запросы для поддержки многоязычности.
- **Шаги выполнения**:
  - [x] Добавить метод get_default_headers() для генерации заголовков с Accept-Language
  - [x] Обновить все GET-запросы в get_basic_routes() для использования новых заголовков
  - [x] Обновить get_options_routes() для поддержки Accept-Language
  - [x] Обновить get_forms_routes() для поддержки Accept-Language
  - [x] Обновить get_standard_custom_post_type_routes() для поддержки Accept-Language
  - [x] Обновить get_individual_page_routes() для поддержки Accept-Language
  - [x] Добавить переменную language в get_variables() со значением по умолчанию
  - [x] Обновить документацию в Project.md с информацией о поддержке Accept-Language
  - [x] Обновить tasktracker.md
- **Зависимости**: Нет

## Задача: Использование реального языка сайта вместо переменной
- **Статус**: Завершена
- **Описание**: Заменить переменную {{language}} на реальный язык сайта из настроек WordPress.
- **Шаги выполнения**:
  - [x] Обновить метод get_default_headers() для использования get_locale()
  - [x] Преобразовать locale в формат RFC 5646 (ru_RU -> ru-RU)
  - [x] Удалить переменную language из get_variables()
  - [x] Обновить документацию в Project.md с информацией об использовании реального языка
  - [x] Обновить tasktracker.md
- **Зависимости**: Добавление заголовка Accept-Language

## Задача: Интеграция с Polylang для определения языка по умолчанию
- **Статус**: Завершена
- **Описание**: Добавить приоритетную проверку плагина Polylang и использование языка по умолчанию из его настроек.
- **Шаги выполнения**:
  - [x] Добавить метод is_polylang_active() для проверки активности плагина Polylang
  - [x] Добавить метод get_default_language() с приоритетом Polylang над WordPress locale
  - [x] Добавить метод convert_language_to_rfc5646() для преобразования языковых кодов
  - [x] Обновить get_default_headers() для использования нового метода получения языка
  - [x] Обновить документацию в Project.md с информацией о поддержке Polylang
  - [x] Обновить tasktracker.md
- **Зависимости**: Использование реального языка сайта

## Задача: Упрощение подхода к преобразованию языковых кодов
- **Статус**: Завершена
- **Описание**: Убрать хардкод языков и упростить логику преобразования языковых кодов.
- **Шаги выполнения**:
  - [x] Удалить метод convert_language_to_rfc5646() с хардкодом языков
  - [x] Упростить метод get_default_language() - убрать преобразование
  - [x] Перенести простое преобразование _ в - в get_default_headers()
  - [x] Обновить документацию в Project.md с упрощенным подходом
  - [x] Обновить tasktracker.md
- **Зависимости**: Интеграция с Polylang

## Задача: Добавление роута для поиска
- **Статус**: Завершена
- **Описание**: Добавить роут для поиска search в базовые маршруты коллекции.
- **Шаги выполнения**:
  - [x] Добавить папку "Search" в get_basic_routes()
  - [x] Создать три типа поисковых запросов: Search Posts, Search Pages, Search All
  - [x] Настроить параметры поиска с примером "example"
  - [x] Добавить поддержку _fields для оптимизации ответа
  - [x] Обновить документацию в Project.md с информацией о поиске
  - [x] Обновить tasktracker.md
- **Зависимости**: Нет

## Задача: Обновление параметров и полей для Posts и Categories
- **Статус**: Завершена
- **Описание**: Обновить параметры и поля для различных типов запросов согласно требованиям.
- **Шаги выполнения**:
  - [x] Обновить List of Posts: добавить отключенный параметр categories=1 и расширить _fields (date, status, excerpt, featured_media, sticky, categories, tags)
  - [x] Добавить отключенный параметр parent=1 в Category by Slug и Category by ID
  - [x] Обновить List of Categories: указать _fields (id,count,description,name,slug,taxonomy,parent,thumbnail,acf,meta)
  - [x] Удалить Taxonomies из стандартных сущностей
  - [x] Создать папку Specific Pages для индивидуальных страниц с названиями как у страниц
  - [x] Обновить tasktracker.md
- **Зависимости**: Нет

## Задача: Отключение Accept-Language заголовка по умолчанию
- **Статус**: Завершена
- **Описание**: Отключить Accept-Language заголовок по умолчанию, но оставить его в коллекции для возможности ручного включения.
- **Шаги выполнения**:
  - [x] Добавить параметр 'disabled' => true в метод get_default_headers()
  - [x] Обновить комментарий метода для отражения изменений
  - [x] Обновить документацию в tasktracker.md
- **Зависимости**: Нет

## Задача: Исправление замечаний WordPress.org Plugin Review
- **Статус**: Завершена
- **Описание**: Исправить все замечания от WordPress.org Plugin Review для соответствия требованиям PCP.
- **Шаги выполнения**:
  - [x] Исправить использование wp_enqueue для JS/CSS в class-postman-admin.php
  - [x] Документировать использование внешних сервисов в readme.txt
  - [x] Исправить прямое подключение core файлов в class-postman-options.php
  - [x] Добавить экранирование переменных при выводе в class-postman-generator.php
  - [x] Обновить документацию в tasktracker.md
- **Зависимости**: Нет

## Задача: Обновление версии плагина до 1.0.3
- **Статус**: Завершена
- **Описание**: Обновить версию плагина с 1.0.2 на 1.0.3 после исправления замечаний WordPress.org Plugin Review.
- **Шаги выполнения**:
  - [x] Обновить версию в postman-collection.php (заголовок и константа)
  - [x] Обновить Stable tag в readme.txt
  - [x] Добавить запись в Changelog с описанием исправлений
  - [x] Обновить Upgrade Notice
  - [x] Обновить версию в файле языков
  - [x] Обновить документацию в tasktracker.md
- **Зависимости**: Исправление замечаний WordPress.org Plugin Review

## Задача: Выбор категорий и роуты постов по категориям
- **Статус**: В процессе
- **Описание**: Добавить в админке выбор категорий (по slug) и генерировать в коллекции запросы списка постов для каждой выбранной категории (`/wp-json/wp/v2/posts?categories={id}`).
- **Шаги выполнения**:
  - [x] Добавить секцию выбора категорий в `Postman_Admin`
  - [x] Пробросить выбранные категории в `Postman_Generator`
  - [ ] Добавить генерацию папки `Posts by Categories` в `Postman_Routes`
  - [ ] Обновить `docs/Project.md`
- **Зависимости**: Базовые маршруты и генератор коллекции

## Задача: Обновление версии плагина до 1.0.4
- **Статус**: Завершена
- **Описание**: Поднять версию после добавления выбора категорий и пагинации.
- **Шаги выполнения**:
  - [x] Обновить версию в `postman-collection.php`
  - [x] Обновить Stable tag в `readme.txt`
  - [x] Добавить записи в Changelog и Upgrade Notice
- **Зависимости**: Функционал выбора категорий и роутов по категориям

## Задача: Проверка совместимости с WordPress 6.9
- **Статус**: Завершена
- **Описание**: Проверить совместимость плагина с WordPress 6.9 и обновить "Tested up to" до 6.9.
- **Шаги выполнения**:
  - [x] Проверить использование устаревших UTF-8 функций (seems_utf8, utf8_encode, utf8_decode) - не найдено
  - [x] Проверить использование блоков (block.json) - не используется, изменения в Post Editor не влияют
  - [x] Проверить использование Flash - не используется
  - [x] Проверить использование стандартных WordPress функций - все корректно (wp_json_encode, REST API)
  - [x] Обновить "Tested up to: 6.9" в trunk/readme.txt
  - [x] Обновить "Tested up to: 6.9" в trunk/mksddn-collection-for-postman.php
  - [x] Обновить документацию в tasktracker.md
- **Зависимости**: Нет

## Задача: Обновление версии плагина до 1.0.5
- **Статус**: Завершена
- **Описание**: Обновить версию плагина с 1.0.4 на 1.0.5 после проверки совместимости с WordPress 6.9.
- **Шаги выполнения**:
  - [x] Обновить версию в mksddn-collection-for-postman.php (заголовок и константа)
  - [x] Обновить Stable tag в readme.txt
  - [x] Добавить запись в Changelog с описанием обновления совместимости
  - [x] Обновить документацию в tasktracker.md
- **Зависимости**: Проверка совместимости с WordPress 6.9