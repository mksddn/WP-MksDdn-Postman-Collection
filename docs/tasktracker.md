...
## Задача: Добавление параметров сортировки и пагинации к роуту List of Posts
- **Статус**: Завершена
- **Описание**: Добавить параметры сортировки (orderby, order) и пагинации (page, per_page, offset) к роуту "List of Posts" в коллекции Postman.
- **Шаги выполнения**:
  - [x] Проанализировать текущую структуру роута List of Posts в class-postman-routes.php
  - [x] Добавить параметры сортировки: orderby=date, order=desc (отключены по умолчанию)
  - [x] Добавить параметры пагинации: page=1, per_page=10, offset=0 (отключены по умолчанию)
  - [x] Обновить описание роута для указания наличия опций сортировки и пагинации
  - [x] Обновить документацию в tasktracker.md
- **Зависимости**: Нет